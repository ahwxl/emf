		...
		Docs.classData ={"id":"apidocs","iconCls":"icon-docs","text":"API Documentation","singleClickExpand":true,"children":[
				...
				,
                {"href":"html/String.html","text":"String","id":"String","isClass":true,"iconCls":"icon-cls","cls":"cls","leaf":true,"frameType":true}
				,
                {"href":"html/Col3D1.html","text":"3D","id":"Number","isClass":true,"iconCls":"icon-cls","cls":"cls","leaf":true,"frameType":true}
				
        ,
                {"href":"html/Pie3D2.html","text":"3D","id":"Number2","isClass":true,"iconCls":"icon-cls","cls":"cls","leaf":true,"frameType":true}
                ,
                {"href":"html/MSCol3D1.html","text":"柱狀圖","id":"Number3","isClass":true,"iconCls":"icon-cls","cls":"cls","leaf":true,"frameType":true}
                ,
                {"href":"html/Col3DLineDY1.html","text":"多系圖","id":"Number4","isClass":true,"iconCls":"icon-cls","cls":"cls","leaf":true,"frameType":true}
                ,
                {"href":"showlist","text":"用戶管理","id":"String","isClass":true,"iconCls":"icon-cls","cls":"cls","leaf":true,"frameType":true}
				]};
        Docs.icons = {

...
<div id="tabs">
	...
	<div id="quartz">
		...
		<ul>
			<li>
				<a href="<c:url value="/addConTrigger" />">添加调度</a>
			</li>
			<li>
				<a href="<c:url value="/showAddConTrigger" />">展示调度</a>
			</li>
			<li>
				<a href="<c:url value="/intConTrigger" />">暂停调度</a>
			</li>
			<li>
				<a href="<c:url value="/resumeConTrigger" />">回復调度</a>
			</li>
		</ul>
	</div>
